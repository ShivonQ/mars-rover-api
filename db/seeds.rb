...
rov1 = RoverManifest.create(name:'Spirit', landing_date:'2004-01-04',  launch_date:'2003-06-10',  max_date:'2010-03-21', portrait:'spirit.jpg', status:'complete',  total_photos:124550)
rov2 = RoverManifest.create(name:'Opportunity', landing_date:'2004-01-25', launch_date:'2003-07-07', max_date:'2017-02-22', portrait:'opportunity.jpg',status:'active', total_photos:187093)
rov3 = RoverManifest.create(name:'Curiosity', landing_date:'2012-08-06', launch_date:'2011-11-26', max_date:'2017-03-12', portrait:'curiosity.jpg',status:'active', total_photos:308239)
